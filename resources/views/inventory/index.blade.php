                ...
                <div class="col-lg-12">
                    <div class="panel no-border">
                        ...
                        <div class="panel-body bg-white">
                            ...
                            <form action="{{ url('food/inventory') }}" method="POST" id="inventoryForm">
                                @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="" class="form-control" placeholder="Enter inventory name" required>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
