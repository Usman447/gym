...
<header class="hidden-print">
    <span class="logo">GYM STATION</span>
    ...
    <div class="leftside hidden-print">
        <div class="sidebar">
            ...
            <ul class="nav-sidebar">
                ...
                @permission(['manage-gymie','view-attendance'])
                <li class="{{ Utilities::setActiveMenu('attendance*') }}">
                    <a href="{{ action('AttendanceController@index') }}">
                        <i class="ion-log-in"></i> <span>Attendance</span>
                    </a>
                </li>
                @endpermission

                @permission(['manage-gymie','manage-food','order-food','add-food-items'])
                <li class="nav-dropdown {{ Utilities::setActiveMenu('food*',true) }}">
                    <a href="#">
                        <i class="ion-fork"></i> <span>Food / Inventory</span>
                    </a>
                    <ul>
                        @permission(['manage-gymie','manage-food','order-food'])
                        <li class="{{ Utilities::setActiveMenu('food/orders*') }}"><a href="{{ action('FoodOrdersController@index') }}">Orders</a></li>
                        @endpermission
                        @permission(['manage-gymie','manage-food','add-food-items'])
                        <li class="{{ Utilities::setActiveMenu('food/items') }}"><a href="{{ action('FoodItemsController@index') }}">Food Items</a></li>
                        @endpermission
                        @permission(['manage-gymie','manage-food','add-food-items'])
                        <li class="{{ Utilities::setActiveMenu('food/inventory*') }}"><a href="{{ action('InventoryController@index') }}">Inventory</a></li>
                        @endpermission
                    </ul>
                </li>
                @endpermission
                ...
                <li class="{{ Utilities::setActiveMenu('members/all') }}">
                ...
                <li class="{{ Utilities::setActiveMenu('subscriptions/all') }}">
                    <a href="{{ action('SubscriptionsController@index') }}">
                ...
                <li class="{{ Utilities::setActiveMenu('invoices/all') }}">
                ...
                <li class="{{ Utilities::setActiveMenu('payments/all') }}">
                    <a href="{{ action('PaymentsController@index') }}">
            ...
            <!-- <li class="nav-dropdown {{-- Utilities::setActiveMenu('reports*',true) --}}">
                ...
                <li class="{{ Utilities::setActiveMenu('plans/all') }}">
                    <a href="{{ action('PlansController@index') }}">
                ...
                <li class="{{ Utilities::setActiveMenu('whatsapp*') }}">
                    <a href="{{ action('WhatsAppController@index') }}">
