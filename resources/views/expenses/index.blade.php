                            ...
                            <div class="row">
                                <div class="col-sm-12 no-padding">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <label for="expense-daterangepicker">Date range</label>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <select name="sort_field" class="form-control selectpicker show-tick show-menu-arrow" id="sort_field">
                                            ...
                                            <option value="amount" {{ old('sort_field') == 'amount' ? 'selected' : '' }}>Amount</option>
                                            <option value="due_date" {{ old('sort_field') == 'due_date' ? 'selected' : '' }}>Due Date</option>
                                            <option value="category_name" {{ old('sort_field') == 'category_name' ? 'selected' : '' }}>Category name</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="gymie_paging pull-right">
                                            {!! str_replace('/?', '?', $expenses->appends(request()->only('search'))->render()) !!}
                                        </div>
                                    </div>
                                </div>
                        </div><!-- / Panel-Body -->
