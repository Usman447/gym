...
Route::group(['prefix' => 'attendance', 'middleware' => ['auth', 'permission:manage-gymie|view-attendance']], function () {
    Route::get('/', 'AttendanceController@index');
    Route::get('/new-records', 'AttendanceController@getNewRecords'); // For auto-refresh
    Route::post('/add-test', 'AttendanceController@addTestAttendance'); // TEMPORARY - For testing
});
...
Route::group(['prefix' => 'enquiries', 'middleware' => ['auth']], function () {
    ...
    Route::post('{id}/markAsLead', ['middleware' => ['permission:manage-gymie|manage-enquiries|view-enquiry'], 'uses' => 'EnquiriesController@markAsLead']);
    ...
    Route::post('{id}/delete', ['middleware' => ['permission:manage-gymie|manage-enquiries|delete-enquiry'], 'uses' => 'EnquiriesController@delete']);
});
...
Route::group(['prefix' => 'food', 'middleware' => ['auth']], function () {
    Route::get('items', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'FoodItemsController@index']);
    Route::post('items', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'FoodItemsController@store']);
    Route::delete('items/{id}', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'FoodItemsController@destroy']);
    
    //food orders
    Route::get('orders', ['middleware' => ['permission:manage-gymie|manage-food|order-food'], 'uses' => 'FoodOrdersController@index']);
    Route::get('orders/create', ['middleware' => ['permission:manage-gymie|manage-food|order-food'], 'uses' => 'FoodOrdersController@create']);
    Route::post('orders', ['middleware' => ['permission:manage-gymie|manage-food|order-food'], 'uses' => 'FoodOrdersController@store']);
    Route::get('orders/{id}', ['middleware' => ['permission:manage-gymie|manage-food|order-food'], 'uses' => 'FoodOrdersController@show']);
    Route::get('orders/{id}/edit', ['middleware' => ['permission:manage-gymie|manage-food|order-food'], 'uses' => 'FoodOrdersController@edit']);
    Route::put('orders/{id}', ['middleware' => ['permission:manage-gymie|manage-food|order-food'], 'uses' => 'FoodOrdersController@update']);
    Route::post('orders/{id}/delete', ['middleware' => ['permission:manage-gymie|manage-food|delete-food'], 'uses' => 'FoodOrdersController@destroy']);
    
    //inventory
    Route::get('inventory', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'InventoryController@index']);
    Route::post('inventory', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'InventoryController@store']);
    Route::get('inventory/{id}/edit', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'InventoryController@edit']);
    Route::put('inventory/{id}', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'InventoryController@update']);
    Route::delete('inventory/{id}', ['middleware' => ['permission:manage-gymie|manage-food|add-food-items'], 'uses' => 'InventoryController@destroy']);
});
...
//WhatsApp
Route::group(['prefix' => 'whatsapp', 'middleware' => ['permission:manage-gymie|manage-settings', 'auth']], function () {
...
//Python Integration Test (Demo)
Route::group(['prefix' => 'python-test', 'middleware' => ['auth', 'permission:manage-gymie']], function () {
    Route::get('/', 'PythonTestController@index');
    Route::post('execute', 'PythonTestController@execute');
});
