...
class AclController extends Controller
{
    ...
    {
        // Hide permissions with group_key "Services" and "SMS" from role creation UI
        $permissions = Permission::whereNotIn('group_key', ['Services', 'SMS'])->get();
    ...
    public function editRole($id)
    {
        ...
        // Hide permissions with group_key "Services" and "SMS" from role editing UI
        $permissions = Permission::whereNotIn('group_key', ['Services', 'SMS'])->get();
    ...
    public function updateRole($id, Request $request)
    {
        ...
        try {
            ...
            $hiddenPermissionsToPreserve = $DBpermissions->intersect($hiddenPermissionIds);
            
            // Add hidden permissions back to ClientPermissions so they won't be deleted
            $ClientPermissions = $ClientPermissions->merge($hiddenPermissionsToPreserve);
